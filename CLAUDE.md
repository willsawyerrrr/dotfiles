...
- When asked to commit, commit directly to `main` — this repo is exempt from the global convention of branching for each change. Never commit without being explicitly asked; the user controls commits here themselves, exempting this repo from the global convention of committing completed work by default.
